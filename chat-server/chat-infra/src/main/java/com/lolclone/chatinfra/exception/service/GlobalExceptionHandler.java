package com.lolclone.chatinfra.exception.service;
...
import com.lolclone.chatinfra.exception.commonexception.ForbiddenException;
...
import com.lolclone.chatinfra.exception.commonexception.UnauthorizedException;
import com.lolclone.chatinfra.exception.commonexception.UnexpectedException;
import com.lolclone.chatinfra.exception.commonexception.ValidException;
import com.lolclone.chatinfra.exception.domain.ExceptionType;
import com.lolclone.chatinfra.exception.dto.ExceptionResponse;
import com.lolclone.chatinfra.exception.dto.ValidErrorResponse;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private void logInfo(ChatException e, HttpServletRequest request) {
        log.info(LOG_FORMAT_INFO, request.getMethod(), request.getRequestURI(), e.getExceptionType(), e.getClass().getName(), e.getMessage());
    }

    private void logWarn(ChatException e, HttpServletRequest request) {
